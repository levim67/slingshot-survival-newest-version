      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-10">
          ...
          <div className="flex flex-col gap-4 w-full max-w-xs">
              ...
              <div className="grid grid-cols-2 gap-4">
                  <button 
                      onClick={onOpenShop}
                      className="bg-purple-600/20 border border-purple-500/50 h-32 rounded-xl flex flex-col items-center justify-center gap-2 hover:bg-purple-600/40 transition-colors group"
                  >
                      <div className="p-3 bg-purple-500 rounded-full group-hover:scale-110 transition-transform shadow-lg shadow-purple-500/40">
                          <ShoppingBag className="text-white" size={24} />
                      </div>
                      <span className="font-bold text-purple-200 uppercase text-sm tracking-wider">Shop</span>
                  </button>

                  <button 
                      className="bg-slate-800/50 border border-white/10 h-32 rounded-xl flex flex-col items-center justify-center gap-2 hover:bg-slate-700/50 transition-colors group"
                  >
                      <div className="p-3 bg-slate-700 rounded-full group-hover:scale-110 transition-transform">
                          <Zap className="text-yellow-400" size={24} />
                      </div>
                      <span className="font-bold text-slate-300 uppercase text-sm tracking-wider">Power-Ups</span>
                  </button>
              </div>
          </div>
      </div>
