...
const ResultsScreen: React.FC<ResultsScreenProps> = ({
    ...
    return (
        <div className="absolute inset-0 z-40 bg-black/95 backdrop-blur-md font-sans overflow-y-auto">
            <div className="min-h-screen flex flex-col items-center justify-center py-12">

                {/* Title */}
                <h2 className="text-4xl font-black text-white italic tracking-widest mb-12 uppercase drop-shadow-[0_0_15px_rgba(255,255,255,0.5)] text-center px-4">
                    Session Complete
                </h2>
